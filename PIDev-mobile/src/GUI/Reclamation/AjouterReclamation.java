        ...
        addRec.addActionListener(e -> {
            try {
                if (title.getText().length() == 0) {
                    ...
                    Reclamation r = new Reclamation(title.getText().toString(), "Réclamation", format.format(new Date()), String.valueOf(description.getText()).toString(), "Non approuvé", "pidevadmintest@gmail.com",1);
